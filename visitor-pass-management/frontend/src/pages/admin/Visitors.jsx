...
function Visitors(){
  ...
  const filteredVisitor = (visitors || []).filter((visitor) => visitor.name.toLowerCase().includes(search.toLowerCase()))
                ...
                <table className="w-full text-left">
                    ...
                    {loading ? (
                        ...
                        {filteredVisitor.map((visitor,index)=>(
                            ...
                            <td className="gap-2">
                                <button className="bg-blue-300 text-blue-900 border-blue-900 border px-3 py-1 rounded me-2 cursor-pointer"><Eye size={18} /></button>
                                <button className="bg-red-300 text-red-900 border-red-800 border px-3 py-1 rounded cursor-pointer" onClick={()=>deleteVisitor(visitor._id)}><Delete size={18} /></button>
                            </td>
                            </tr>
                        ))}
                    </tbody>
